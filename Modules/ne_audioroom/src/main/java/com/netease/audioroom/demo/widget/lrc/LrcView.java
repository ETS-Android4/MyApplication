...
public class LrcView extends View {
    ...
    private float mLrcCurrentTextSize;
    ...
    private boolean isEnableShowIndicator = false;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLrcCurrentTextSize = typedArray.getDimension(R.styleable.LrcView_lrcCurrentTextSize, sp2px(context, 18));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < getLrcCount(); i++) {
            ...
            if (mCurrentLine == i) {
                ...
                mTextPaint.setTextSize(mLrcCurrentTextSize);
