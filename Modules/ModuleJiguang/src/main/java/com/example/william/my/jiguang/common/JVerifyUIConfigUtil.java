...
import com.example.william.my.module.utils.ScreenUtils;
...
public class JVerifyUIConfigUtil {
    ...
    public static JVerifyUIConfig getConfig(Context context, Direction direction) {
        ...
        if (direction == Direction.dialogPortrait || direction == Direction.dialogLandscape) {
            int widthDp = SizeUtils.px2dp(ScreenUtils.getScreenWidth());
            int heightDp = SizeUtils.px2dp(ScreenUtils.getScreenHeight());
        ...
        if (direction == Direction.portrait || direction == Direction.landscape) {
            ...
            if (direction == Direction.portrait) {
                layoutParamPhoneLogin.setMargins(0, SizeUtils.dp2px(340f), 0, 0);
                ...
                layoutParamPhoneLogin.setMargins(0, SizeUtils.dp2px(15.0f), SizeUtils.dp2px(15.0f), 0);
        ...
        if (direction == Direction.portrait || direction == Direction.landscape) {
            ...
            layoutLoginGroupParam.setMargins(0, SizeUtils.dp2px(direction == Direction.portrait ? 450f : 230f), 0, 0);
        ...
        if (direction == Direction.dialogPortrait || direction == Direction.dialogLandscape) {
            ...
            btnParams.setMargins(0, SizeUtils.dp2px(10.0f), SizeUtils.dp2px(10), 0);
