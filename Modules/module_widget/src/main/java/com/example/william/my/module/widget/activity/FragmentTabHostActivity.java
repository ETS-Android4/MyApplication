...
@Route(path = ARouterPath.Widget.Widget_FragmentTabHost)
public class FragmentTabHostActivity extends BaseActivity {
    ...
    //Fragment界面数组
    private final Class<?>[] mFragmentArray = {PrimaryFragment.class, PrimaryVarFragment.class, BasicRecyclerFragment.class};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.widget_activity_fragment_tabhost);
    ...
    private View getTabView(int[] imageArray, String[] textArray, int i) {
        View view = getLayoutInflater().inflate(R.layout.widget_item_tab_fragment, mTabs, false);
