 ...
 * 好友关系链管理消息adapter
 */
public class NewFriendAdapter extends ArrayAdapter<V2TIMFriendApplication> {
     ...
     */
    public NewFriendAdapter(Context context, int resource, List<V2TIMFriendApplication> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (data.getType()) {
            case V2TIMFriendApplication.V2TIM_FRIEND_APPLICATION_COME_IN:
                mViewHolder.agree.setText(getContext().getResources().getString(R.string.request_agree));
            ...
            case V2TIMFriendApplication.V2TIM_FRIEND_APPLICATION_SEND_OUT:
                mViewHolder.agree.setText(getContext().getResources().getString(R.string.request_waiting));
                break;
            case V2TIMFriendApplication.V2TIM_FRIEND_APPLICATION_BOTH:
                mViewHolder.agree.setText(getContext().getResources().getString(R.string.request_accepted));
                break;
        }
        return mView;
    }
