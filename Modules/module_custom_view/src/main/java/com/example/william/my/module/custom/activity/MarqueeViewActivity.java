...
public class MarqueeViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custom_activity_marquee_view);
        ...
        for (int i = 0; i < mData.length; i = i + 2) {
            //设置滚动的单个布局
            LinearLayout viewGroup = (LinearLayout) getLayoutInflater().inflate(R.layout.custom_item_marquee, (ViewGroup) getWindow().getDecorView(), false);
            //初始化布局的控件
