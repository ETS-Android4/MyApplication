...
public class BRVAHProvider2 extends BaseItemProvider<String> {
    ...
    public void convert(BaseViewHolder baseViewHolder, String s) {
        ...
        baseViewHolder.setBackgroundColor(R.id.item_textView, ContextCompat.getColor(context, R.color.basics_colorPrimaryDark));
    }
}
