...
public class SampleActivity extends BaseRecyclerActivity {
    ...
    protected ArrayList<RouterItem> buildRouter() {
        ...
        routerItems.add(new RouterItem("SuspendActivity", ARouterPath.Sample.Sample_Suspend));
        ...
        routerItems.add(new RouterItem("DataBingActivity", ARouterPath.Sample.Sample_DataBing));
        return routerItems;
    }
}