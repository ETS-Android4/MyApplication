package com.example.william.my.module.sample.holder
...
import com.example.william.my.module.sample.databinding.KtItemRecycleBinding

class LoadStateViewHolder(parent: ViewGroup, retry: () -> Unit) : RecyclerView.ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.kt_item_recycle, parent, false)) {
