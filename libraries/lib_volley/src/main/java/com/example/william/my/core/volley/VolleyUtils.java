...
public class VolleyUtils {
    ...
    public static <T> VolleyPostFormBuilder<T> builder() {
        return new VolleyPostFormBuilder<>();
    }

    public static class VolleyPostFormBuilder<T> {
        ...
        public VolleyPostFormBuilder<T> url(String url) {
            this.url = url;
            return this;
        }

        public VolleyPostFormBuilder<T> addParams(String key, String val) {
            if (this.params == null) {
        ...
        public VolleyPostFormBuilder<T> clazz(Class<T> clazz) {
            this.clazz = clazz;
            return this;
        }
    ...
    public static class VolleyRequest<T> {
        ...
        public void enqueue(VolleyListener<T> listener) {
            volleyQueue.add(new VolleyJsonRequest<T>(Request.Method.POST, url, clazz, context,
    ...
    public static class VolleyJsonRequest<T> extends Request<T> {
        ...
        private VolleyJsonRequest(int method, String url, Class<T> mClazz, Context mContext,
