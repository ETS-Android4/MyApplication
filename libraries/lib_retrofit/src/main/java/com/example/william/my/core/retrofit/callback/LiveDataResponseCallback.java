 ...
 */
public class LiveDataResponseCallback<Bean, Data> implements ResponseCallback<RetrofitResponse<Bean>> {
     ...
     * @param liveData Data
     */
    public LiveDataResponseCallback(MutableLiveData<RetrofitResponse<Data>> liveData) {
        this(liveData, null);
    }
     ...
     * @param liveData Data
     */
    public LiveDataResponseCallback(MutableLiveData<RetrofitResponse<Data>> liveData, LiveDataConvert<Bean, Data> convert) {
