...
public class BannerIndicatorConfig {
    ...
    public BannerIndicatorConfig setMargins(Margins margins) {
    ...
    public BannerIndicatorConfig setIndicatorSize(int indicatorSize) {
    ...
    public BannerIndicatorConfig setNormalColor(int normalColor) {
    ...
    public BannerIndicatorConfig setSelectedColor(int selectedColor) {
    ...
    public BannerIndicatorConfig setIndicatorSpace(int indicatorSpace) {
    ...
    public BannerIndicatorConfig setCurrentPosition(int currentPosition) {
    ...
    public BannerIndicatorConfig setNormalWidth(int normalWidth) {
    ...
    public BannerIndicatorConfig setSelectedWidth(int selectedWidth) {
    ...
    public BannerIndicatorConfig setGravity(@Direction int gravity) {
    ...
    public BannerIndicatorConfig setRadius(int radius) {
        this.radius = radius;
        return this;
    }
    ...
    public BannerIndicatorConfig setHeight(int height) {
        this.height = height;
        return this;
    }
}
