 ...
 * {@link #ensureContainerAndBehavior}
 * {@link #wrapInBottomSheet}
 */
public class ViewPagerBottomSheetDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (container == null) {
            ...
            container =
                    (FrameLayout) View.inflate(getContext(), R.layout.design_view_pager_bottom_sheet_dialog, null);
    ...
    private View wrapInBottomSheet(
        ...
        layoutParams.height = ScreenUtils.getScreenHeight(getContext()) - ScreenUtils.getStatusBarHeight();
