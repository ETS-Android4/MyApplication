...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        //进度条颜色
        roundColor = a.getColor(R.styleable.RoundProgressBar_roundColor, ContextCompat.getColor(context, R.color.colorPrimary));
        roundProgressColor = a.getColor(R.styleable.RoundProgressBar_roundProgressColor, ContextCompat.getColor(context, R.color.colorPrimaryDark));
        //进度条宽度
        ...
        //进度条进度
        textColor = a.getColor(R.styleable.RoundProgressBar_textColor, ContextCompat.getColor(context, R.color.colorPrimaryDark));
