...
public class IosItemAlertDialog {
    ...
    public IosItemAlertDialog(Activity context) {
        this.context = context;
    }

    public IosItemAlertDialog builder() {
        View view = LayoutInflater.from(context).inflate(R.layout.basics_ios_dialog_item,
     ...
     * 设置标题
     */
    public IosItemAlertDialog setTitle(String title) {
        showTitle = true;
     ...
     * 是否可以取消
     */
    public IosItemAlertDialog setCancelable(boolean cancel) {
     ...
     * 是否可以取消
     */
    public IosItemAlertDialog setCanceledOnTouchOutside(boolean cancel) {
        dialog.setCanceledOnTouchOutside(cancel);
        return this;
    }

    public IosItemAlertDialog addAlertItem(String strItem, OnItemClickListener listener) {
        if (alertItems == null) {
    ...
    public IosItemAlertDialog addAlertItem(String strItem, int color, OnItemClickListener listener) {
        if (alertItems == null) {
            alertItems = new ArrayList<>();
        }
