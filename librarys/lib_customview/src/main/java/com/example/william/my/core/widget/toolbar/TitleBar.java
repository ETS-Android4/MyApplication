...
public class TitleBar extends RelativeLayout {
    ...
    public static TitleBar setContentView(Activity activity, int layoutResID) {
        ...
        //将layoutResID添加到contentView
        LayoutInflater.from(activity).inflate(layoutResID, parent, true);
